...
def _kb_ciclo_s():
    ...
    Default 18s (2026-07-13, editora: 'o zoom in e out ficava muito rápido, deixar bem suave' — antes
    12s ≈ 4,7%/s; 18s ≈ 3,1%/s, ainda claramente visível sem ser acelerado)."""
    try:
        return max(0.0, float(os.environ.get("ROTEIRO_KENBURNS_CICLO", "18")))
    except (TypeError, ValueError):
        return 12.0
