...
def _instr(nums):
    ...
    return (
        ...
        "duplicada ou partida ao meio, corpos grudados de forma impossível. INCLUI braço/mão em "
        "pose IMPOSSÍVEL mesmo com o número certo de membros: braço dobrado ao contrário, "
        "cotovelo/pulso torto, membro deslocado ou saindo do lugar errado do corpo, braço "
        "esticado/curto/fino demais, mão presa na posição errada — se o braço 'parece estranho' "
        "ou uma pessoa real não conseguiria ficar assim, MARQUE (foi o bug do 'homem com braço "
        "estranho').\n"
